...
// void reversal_Of_List(){
//     node ptr = start, pre_ptr = NULL, present_ptr = start;
    
//     while( ptr != NULL){
//         ptr = ptr -> next;
//         present_ptr -> next = pre_ptr;
...
int main(){
    ...
    while(1){
        ...
        printf("\n8.ENTER TO SIZE OF THE LIST.");
        printf("\n9.ENTER TO CHECK IF EMPTY.");
        printf("\n10.ENTER TO SEARCH FOR AN ELEMENT.");
        printf("\n11.ENTER TO REVERSE THE SINGLY LINKED LIST.");
        printf("\n12.EXIT.");
        printf("\n\nENTER YOUR CHOICE :");
        scanf("%d",&choice);
